...
func seedRealIndexedCodebase(t *testing.T, manager *Manager, repoPath string, fileCount int) model.Codebase {
	...
	if err := service.StageReindex(context.Background(), canonicalPath, chunks, semantic.RemovePaths(nil), nil, nil, semantic.StoreColumnSetCode, semantic.ReuseFromCorpus); err != nil {
